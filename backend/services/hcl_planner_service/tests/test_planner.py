...
from backend.services.hcl_planner_service.config import GeminiSettings
from backend.services.hcl_planner_service.core.planner import (
    AgenticPlanner,
...
def fixture_mock_gemini_client():
    ...
    with patch("backend.services.hcl_planner_service.core.planner.GeminiClient") as mock:
