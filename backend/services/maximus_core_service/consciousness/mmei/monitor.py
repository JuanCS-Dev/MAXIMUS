...
from consciousness.mmei.needs_computation import NeedsComputation
from consciousness.mmei.rate_limiter import RateLimiter  # Re-export for backward compat
