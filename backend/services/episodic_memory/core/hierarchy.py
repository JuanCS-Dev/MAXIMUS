...
from ..models.memory_types import (
    TypedMemory,
    MemoryType,
    MemoryPriority,
    MemoryTypeConfig
...
class MemoryHierarchy:
    ...
    async def search(
        ...
        if memory_types is None or MemoryType.CORE in memory_types or MemoryType.VAULT in memory_types:
    ...
    def _search_l1(self, query_embedding: List[float], limit: int) -> List[TypedMemory]:
